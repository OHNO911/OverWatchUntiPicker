...
export const DEFAULT_HERO_DATA = [
    ...
    { id: "domina",         name: "ドミナ",             role: "tank",    archetype: "poke", matchups: { dive: 3, rush: 3, poke: 1 }, antis: { "ウィンストン": 4, "ドゥームフィスト": 4, "トレーサー": 3, "バスティオン": 3, "ジャンクラット": 2, "ハンゾー": 2 } },
    ...
    { id: "emre",           name: "エムレ",             role: "damage",  archetype: "poke", matchups: { dive: 3, rush: 3, poke: 1 }, antis: { "ウィンストン": 3, "D.Va": 3, "ドゥームフィスト": 3, "トレーサー": 3, "ゲンジ": 3, "ブリギッテ": 2, "アナ": 1, "キャスディ": 2 } },
    { id: "anran",          name: "アンラン",           role: "damage",  archetype: "rush", matchups: { dive: 2, rush: 1, poke: 3 }, antis: { "キャスディ": 3, "アッシュ": 3, "ソルジャー76": 3, "アナ": 2, "ブリギッテ": 3, "オリーサ": 2, "ルシオ": 1 } },
    { id: "freja",          name: "フレイヤ",           role: "damage",  archetype: "poke", matchups: { dive: 2, rush: 1, poke: 1 }, antis: { "D.Va": 2, "ウィドウメイカー": 3, "ソルジャー76": 2, "バティスト": 3, "ウィンストン": 3, "レッキング・ボール": 2, "トレーサー": 2 } },
    ...
    { id: "pharah",         name: "ファラ",             role: "damage",  archetype: "poke", matchups: { dive: 2, rush: 2, poke: 3 }, antis: { "エコー": 3, "ウィドウメイカー": 2, "キャスディ": 2, "ソルジャー76": 2, "イラリー": 2, "バティスト": 2, "アナ": 1, "D.Va": 3, "マーシー": 1 } },
    ...
    { id: "tracer",         name: "トレーサー",         role: "damage",  archetype: "dive", matchups: { dive: 2, rush: 2, poke: 1 }, antis: { "ソンブラ": 1, "キャスディ": 3, "トールビョーン": 3, "ヴェンデッタ": 1 } },
    ...
    { id: "jetpack-cat",    name: "ジェットパックキャット", role: "support", archetype: "dive", matchups: { dive: 1, rush: 1, poke: 3 }, antis: { "アッシュ": 3, "イラリー": 2, "ソルジャー76": 3, "キャスディ": 3, "D.Va": 2 } },
    { id: "mizuki",         name: "ミズキ",             role: "support", archetype: "rush", matchups: { dive: 3, rush: 3, poke: 1 }, antis: { "ウィンストン": 3, "D.Va": 3, "ドゥームフィスト": 3, "トレーサー": 3, "ゲンジ": 3, "モイラ": 2, "ザリア": 2, "シンメトラ": 2 } },
    ...
    { id: "zenyatta",       name: "ゼニヤッタ",         role: "support", archetype: "poke", matchups: { dive: 3, rush: 2, poke: 2 }, antis: { "レッキング・ボール": 2, "ドゥームフィスト": 2, "ジャンカークイーン": 1, "D.Va": 2, "ベンチャー": 3, "ソンブラ": 2, "トレーサー": 3, "ゲンジ": 3, "ウーヤン": 1 } },
];
